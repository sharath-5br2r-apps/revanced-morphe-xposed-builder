...
def main():
    token = os.environ.get("GH_TOKEN") or os.environ.get("PERSONAL_ACCESS_TOKEN") or os.environ.get("GITHUB_TOKEN")
    if not token:
        print("GH_TOKEN is not set. Skipping usage tracker update.")
        return
