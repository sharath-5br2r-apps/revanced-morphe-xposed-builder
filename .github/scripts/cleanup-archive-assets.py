...
def cleanup_release(tag):
    ...
    # e.g. google-photos-morphe-v7.84.0.949657053-armeabi-v7a.apk
    ...
    pattern = re.compile(r'^(.*?)-((?:[vV]?[0-9]|[vV][A-Z]).*?)-(arm64-v8a|armeabi-v7a|universal|all|module|x86|x86_64)\.(apk|zip)$')
