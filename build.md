...
gboard-morphe-jasonwu1994 (arm64-v8a): 17.7.7.932364120-release-arm64-v8a  
gboard-morphe-jasonwu1994-clone (arm64-v8a): 17.7.7.932364120-release-arm64-v8a  
github-morphe-hoodles (all): 1.267.0  
prime-video-morphe-hoodles (arm64-v8a): 3.0.466  
adobe-acrobat-morphe-hooman (arm64-v8a): 26.6.1  
symfonium-morphe-hooman (all): 14.1.0  
adm-morphe-hooman (all): 14.0.39  
tiktok-morphe-icysymmetra (all): 43.8.3  
...
discord-npatch-revenge (all): 340.13-Stable  
...
Patches: anddea/patches-4.2.0-dev.14.mpp  
[Changelog](https://github.com/anddea/revanced-patches/releases/tag/v4.2.0-dev.14)

Patches: arandomhooman/patches-1.44.0-dev.3.mpp  
[Changelog](https://github.com/arandomhooman/hoomans-morphe-patches/releases/tag/v1.44.0-dev.3)
...
Patches: crimera/patches-3.9.0-dev.6.mpp  
[Changelog](https://github.com/crimera/piko/releases/tag/v3.9.0-dev.6)
...
Patches: jasonwu1994/patches-2.7.0-dev.3.mpp  
[Changelog](https://github.com/jasonwu1994/Gboard-patches/releases/tag/v2.7.0-dev.3)
...
Patches: rushiranpise/patches-1.17.0-dev.1.mpp  
[Changelog](https://github.com/rushiranpise/morphe-patches/releases/tag/v1.17.0-dev.1)  
